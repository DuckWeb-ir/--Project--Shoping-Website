...
const ContactUSPage = () => {
    ...
    const { form, changeHandler, submitHandler, isSubmiting } = useContactUs({
        name: "",
        phone: "",
        subject: "",
        content: "",
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center text-sm mt-10 justify-end gap-3">
                        ...
                        <button
                            className={` bg-linear-to-t from-blue-600 px-4 py-2.5 rounded-md text-white focus-within:ring-4 ring-sky-300/50 ring-offset-2 duration-150 to-blue-400 max-w-max
                            ${isSubmiting
                        ...
                        >
                            {isSubmiting ? "در حال ارسال..." : "ثبت و ارسال"}
                        </button>
                    </div>
                </form>
